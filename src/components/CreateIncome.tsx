/**
 * File: CreateIncome.tsx
 * Author: Stephen Thomson
 * Date Created: 11/30/2024
 * Description:
 * This component allows users to create a new income account. It interacts with the backend 
 * to create the account and initializes an entry in the blockchain ledger for transaction tracking.
 *
 * Functionalities:
 * - Users can input the account name and set the starting date of the account.
 ...
 * Description:
 * This component renders a form for creating a new income account. It collects the account name 
...
const CreateIncome: React.FC = () => {
  ...
  const handleCreateAccount = async () => {
    try {
      ...
      const accountData = {
        accountName,
        basket: 'income', // Indicates the type of account
      };
      ...
      const transactionData = {
        ...
        debitAmount: 0, // Initial balance for income accounts is 0
        creditAmount: 0,
        userPublicKey,
      };
